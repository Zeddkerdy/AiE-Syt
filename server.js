...
setInterval(() => {
  http.get(`http://aiesystem.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  
    if (msg.content === 'facebook') {  
      msg.reply('**https://www.facebook.com/Arab-in-Europe-RolePlay-102601464930355**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'hbhosting') {  
      msg.reply('**www.hbhosting.de**');  
    }
  });
  ...
  client.on('message', msg => {  
    if (msg.content === 'whatsapp') {  
      msg.reply('**https://chat.whatsapp.com/BdHVBZHMWYSATTe98M7YJ3**');  
    }
  });
   ...
   client.on('message', msg => {  
    if (msg.content === 'youtube') {  
      msg.reply('**https://www.youtube.com/channel/UCIiXAB8Bkbm3W6Kuj6uicAg**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'ip') {  
      msg.reply('**connect aie.hbhosting.de**');  
    }
  });


client.on('message', msg => {  
    if (msg.content === 'godziiyx') {  
      msg.reply('**https://www.youtube.com/channel/UC5gPuIIdRtpOMTl-GdIhquQ**');  
    }
  });


client.on('message', msg => {  
    if (msg.content === 'hussein') {  
      msg.reply('**https://www.facebook.com/husseingamingstrem/**');  
    }
  });


client.on('message', msg => {  
    if (msg.content === 'yousef') {  
      msg.reply('**https://www.facebook.com/ShamGamerwarzone-590377721638549**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'hbstore') {  
      msg.reply('**https://discord.gg/kYrykUT**');  
    }
  });
...
client.login('NzYyMTA4ODY3MTY5MDkxNjA2.X3kXMQ.Xa9OjeUO5sbytc__EXE7CXAGzpw');
